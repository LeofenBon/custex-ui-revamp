...
export default function SideBar() {
  ...
  return (
    <aside className="sidebar fixed left-0 sidebar-mobile top-[72.75px] h-[715px] w-64 max-sm:fixed max-sm:-translate-x-full text-black dark:text-white bg-primaryLight dark:bg-primaryDark">
              ...
              <li>
                ...
                <div className="menu-item-collapse">
                  <div className="min-h-0">
                    <label className="menu-item text-black dark:text-white menu-item-disabled ml-6">
                      Change Email
                    </label>
                    <label className="menu-item text-black dark:text-white ml-6">
                      Profile
                    </label>
                    <label className="menu-item text-black dark:text-white ml-6">
                      Change Password
